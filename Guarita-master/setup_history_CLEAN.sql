-- Sistema de Histórico e Limpeza Automática - VERSÃO LIMPA
...
-- Passo 2: Criar tabela de histórico
...
-- Passo 4: Criar função de arquivamento
...
-- Passo 5: Criar função de consulta
